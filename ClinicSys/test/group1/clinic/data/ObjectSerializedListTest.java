...
public class ObjectSerializedListTest {
	...
	{
		out.println("\nTesting the getPatientDatabase");
		setup();

		testGetPatientDatabase("Case 1 valid data",
				"testfiles/testPatients.txt", "testfiles/testVisits.txt",
				DefaultPatientVisitFactory.DEFAULT, true);
		testGetPatientDatabase("Case 2 null SequentialTextFileList", null, null, DefaultPatientVisitFactory.DEFAULT, false);
		testGetPatientDatabase("Case 3 null DefaultPatientVisitFactory",
	...
	{
		out.println("\nTesting the getVisitDatabase");
		setup();

		testGetVisitDatabase("Case 1 valid data",
				"testfiles/testPatients.txt", "testfiles/testVisits.txt",
				DefaultPatientVisitFactory.DEFAULT, true);
		testGetVisitDatabase("Case 2 null SequentialTextFileList", null, null, DefaultPatientVisitFactory.DEFAULT, false);
		testGetVisitDatabase("Case 3 null DefaultPatientVisitFactory",
			"testfiles/testPatients.txt", "testfiles/testVisits.txt", null, false);
	...
	{
		out.println("\nTesting the savePatientDatabase");
		setup();

		testSavePatientDatabase("Case 1 valid data",
				"testfiles/testPatients.txt", "testfiles/testVisits.txt",
				DefaultPatientVisitFactory.DEFAULT, true);
		testSavePatientDatabase("Case 2 null SequentialTextFileList", null, null, DefaultPatientVisitFactory.DEFAULT, false);
		testSavePatientDatabase("Case 3 null DefaultPatientVisitFactory",
			"testfiles/testPatients.txt", "testfiles/testVisits.txt", null, false);
