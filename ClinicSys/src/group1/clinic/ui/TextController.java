...
/**
 * Controller for the TextApp for a PatientVisitManager. Provides a text-based
 * menu that allows a person to view patient information, add new patients, add
 * new visits, get the next triage visit and assign priorities to it, and
 * request the next examination visits.
 * 
...
public class TextController {
	 ...
	 * 
	 * @param model
	 *            The PatientVisitManager to be used.
	 */
	...
	/**
	 * Adds a new patient to the database. Requests information from the user,
	 * and then creates the patient.
	 */
	private void addPatient() {
		...
		try {
			// Requests each piece of information about the patient and saves
			// them
			...
			out.print("Please enter any existing medical conditions, or " + "press enter if none available: ");
			existingMedCond = userInput.readLine();

			// Check if user did not put any input for existing medical
			// conditions
	...
	private void addVisit() {
		...
		try {
			...
			out.print("Please enter the primary complaint of patients, or " + "press enter if unknown: ");
